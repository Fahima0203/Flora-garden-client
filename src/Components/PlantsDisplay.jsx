...
function PlantsDisplay() {
  ...
  useEffect(() => {
    axios
      ...
      .get("https://flora-garden-client.onrender.com/fetch")
  ...
  return (
    <>
      ...
      <form className="d-flex" action="https://www.google.com/search" style={{ margin: "10px 25% 40px 25%", maxWidth: 400, align: "center" }} >
        <Form.Control
          type="search"
          name="q"
          id="search"
